...
export default function InscriptionPage() {
  ...
  const phrases = [
    "Rejoins la communauté et ne lâche plus jamais un projet.",
    "Chaque ligne de code est une victoire sur l'abandon.",
    "Ensemble, on transforme les idées en projets terminés.",
    "Ton prochain projet mérite d'être fini. On t'aide.",
    "L'entraide, c'est la force qui fait avancer les devs.",
  ]
